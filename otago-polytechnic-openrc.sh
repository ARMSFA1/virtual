...
export OS_AUTH_URL=https://api.nz-hlz-1.catalystcloud.io:5000/v3
export OS_IDENTITY_API_VERSION=3
# Set the domain name for authentication.
export OS_USER_DOMAIN_NAME="Default"
export OS_PROJECT_DOMAIN_ID="default"
# Set the user name.
export OS_USERNAME="ARMSFA1@student.op.ac.nz"
...
export OS_PROJECT_ID=5db430d3f4d0481c87d875d9f811f2d5
export OS_PROJECT_NAME="otago-polytechnic"
# Set the region name.
